...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\input{extendedAbstract} % Between 750 and 2000 words, up to 10 references
...
\begin{thebibliography}{99}
	...
	\bibitem[K{\"u}hn and P{\"o}hle(2018)]{KP}
	K{\"u}hn,~S., P{\"o}hle,~D., 2018.
	``Neuartige Approximation von Fahrdynamikeigenschaften f{\"u}r die Trasseneignungspr{\"u}fung",
	In: {\em Proceedings of the 26th Verkehrswissenschaftliche Tage, Dresden, 2018},
	TUDpress, Dresden.

	\bibitem[Li et~al.(2017)]{XL}
	...
	\bibitem[Streitzig et~al.(2016)]{CS}
	...
	\bibitem[Wei{\ss}  et~al.(2018)]{RW}
	Wei{\ss},~R., Nachtigall,~K., Martin,~U., Oetting,~A., 2018.
	``Bewertung einer effizienten marktgeeigneten Trassenbelegung im spurgeführten Verkehr",
	{\em Eisenbahntechnische Rundschau},
	vol. 2.

	\bibitem[EEIG Corridor Rhine-Alpine EWIV(2019)]{Kor1}
