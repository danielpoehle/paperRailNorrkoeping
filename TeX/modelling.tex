...
As certain Fahrwege are preferred to others, we multiply the costs with factor greater or equal to one, with larger factors for less desirable Fahrwege. This way the use of intersections and the use of tracks designated for the opposite direction can be discouraged. It is this graph we use for finding routes for our train paths.
...
\begin{figure}[tb]
	...
	\caption{Left: parts of multiple train paths shown as blocking times.
