...
Numerical experiments are accompanied to show that our solution exceeds manual timetabling in terms of capacity useage, transportation times and the time taken for creating the timetable.
\end{abstract}
