...
The experiments, as provided in Table 2 and 3, show that the creation of the timetable for Corridor One takes about 5,5 hours to assign 210 customers' request on 935.814 slots, where 80\% of the requests use the systemized slots and the average BFQ of them is 1,27\%. This is also a vast improvement compared to the up to serveral days required process in the current manual process. Moreover it shows, that the way we produce our slots is more effizient then the manual ones since we are able to produce more capacity on the infrastructure. This can be seen by the percentage rise of different points, e.g. Bensheim, where we produce 2,83\% more slots then we did manual in 2013. 